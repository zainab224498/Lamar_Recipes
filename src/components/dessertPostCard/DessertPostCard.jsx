...
function DessertPostCard() {
  const context = useContext(myContext);
  const { mode, getAllDessert } = context;
                ...
                {getAllDessert.map((item, index) => (
                  <div className="p-4" key={index}>
                    <div
                      ...
                      onClick={() => navigate(`/dessertinfo/${item.id}`)}
                    >
                      <img className="w-full" src={item.thumbnail} alt="dessert" />
                      <div className="p-6">
                        <h2
...
export default DessertPostCard;
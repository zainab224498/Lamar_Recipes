...
export default function Nav() {
    ...
    const navList = (
        <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
            ...
            >
                <Link to={'/allfoods'} className="flex items-center">
                    Food
                </Link>
            </Typography>
            <Typography
                ...
                style={{ color: mode === 'dark' ? 'white' : 'white' }}
            >
                <Link to={'/alldesserts'} className="flex items-center">
                    Desserts
                </Link>
            </Typography>
            <Typography
                ...
                style={{ color: mode === 'dark' ? 'white' : 'white' }}
            >
                <Link to={'/allsnacks'} className="flex items-center">
                    Snacks
                </Link>
            </Typography>
            <Typography
                ...
                style={{ color: mode === 'dark' ? 'white' : 'white' }}
            >
                <Link to={'/alldrinks'} className="flex items-center">
                    Drinks
                </Link>
            </Typography>
            <Typography
    ...
    return (
        <>
            ...
            <Navbar
                ...
                style={{ background: mode === 'dark' ? 'rgb(55, 179, 77)' : 'rgb(55 179 77)' }}>
                ...
                <div className="flex items-center justify-between text-blue-gray-900">
                    ...
                    <Link to={'/'}>
                        ...
                        >
                            ...
                            <img
                                className=' w-10 h-10 '
                                src='https://www.freeiconspng.com/thumbs/recipes-icon-png/free-recipe-sheet-clip-art-21.png'
                            />
                            {/* Logo Text  */}
                            <span>
                                LAMAR Recipes

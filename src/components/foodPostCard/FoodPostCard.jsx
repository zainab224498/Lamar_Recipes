                ...
                {getAllFood.map((item, index) => (
                  <div className="p-4" key={index}>
                    <div
                      ...
                      className={`h-full shadow-lg hover:-translate-y-1 cursor-pointer hover:shadow-gray-400 ${mode === 'dark' ? 'shadow-gray-700' : 'shadow-xl'
                        } rounded-xl overflow-hidden`}
                      onClick={() => navigate(`/foodinfo/${item.id}`)}
                    >
                      <img className="w-full" src={item.thumbnail} alt="food" />
                      <div className="p-6">
                        <h2
